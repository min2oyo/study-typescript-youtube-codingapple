const _interface = () => {
  ...
  const 상품: Product = { brand: 'Samsung', serialNumber: 1360, model: ['TV', 'phone'] };
  ...
  const 장바구니: Cart[] = [{ product: '청소기', price: 7000 }, { product: '삼다수', price: 800 }];
